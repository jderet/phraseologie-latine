...
- **Une traduction par projet** (choix du 19 septembre 2026, qui remplace « chacun sa version » de Q36 et la version de référence de T6) : un projet vise une seule traduction latine de son texte, dans un style choisi à sa création pour tout le projet. Un même texte peut avoir plusieurs projets, dans des styles différents ou non.
  - La **traduction** naît avec le projet, en brouillon. Le créateur du projet et les personnes qu'il nomme l'écrivent (voir « Rôles d'un projet ») ; les éditeurs la publient.
  - ~~Tout compte actif peut proposer une variante : une copie de la dernière étape publique de la traduction principale, envoyée aux mainteneurs comme proposition de modifications, close une fois tranchée.~~ Remplacé le 21 septembre 2026 : voir « Variantes par phrase » ci-dessous. La copie d'une traduction entière disparaît ; qui veut traduire autrement le même texte crée un autre projet.
  - Les éditeurs décident aussi du glossaire et des sujets du projet.
  - La page « Traduction » présente les textes d'abord : sous chaque texte, ses projets, leur style et l'avancement de leur traduction. L'ancienne liste des projets y renvoie.
- **Variantes par phrase** (choix du 21 septembre 2026, qui remplace la variante-copie du 19 septembre 2026) : un projet n'a qu'une traduction, mais chaque phrase peut porter plusieurs **variantes**.
  - Une variante porte un latin, un **commentaire** et un **statut** : **proposition** (son auteur propose de remplacer le texte visé) ou **pour référence** (il indique une autre traduction, sans demander de remplacement).
  - Une variante vise le texte principal de la phrase, ou une autre variante de la même phrase ; les variantes d'une phrase forment ainsi un arbre, affiché sous elle.
  - **Adopter** une proposition met son latin à la place du texte visé ; le texte remplacé reste, comme variante « pour référence ». Une proposition **refusée** devient « pour référence ». Rien n'est effacé : une phrase garde toutes les traductions qu'on lui a données.
  - Les traducteurs et les éditeurs adoptent ou refusent ; la discussion se tient dans les commentaires de la phrase.
- **Rôles d'un projet** (choix du 21 septembre 2026, qui remplace les mainteneurs du 19 septembre 2026) : trois rôles, emboîtés.
  - **Éditeur** : tout ce qui touche au projet — le modifier, le supprimer, le publier, nommer et retirer les traducteurs et les correcteurs, ouvrir ou fermer la correction. Le créateur du projet en est éditeur. Un éditeur a les droits d'un traducteur.
  - **Traducteur** : auteur de la traduction. Il écrit le texte principal à l'envi, crée des étapes, ajoute et supprime des variantes, adopte ou refuse les propositions. Il a les droits d'un correcteur.
  - **Correcteur** : il ajoute des variantes — du texte principal ou d'une variante — et commente ; il ne touche pas au texte principal.
  - La correction est **ouverte à tout compte actif par défaut** ; un éditeur peut la réserver aux correcteurs nommés. Une variante compte dans la limite des nouveaux comptes (T10).
- **Genres et thèmes des textes** (choix du 20 septembre 2026) : chaque texte à traduire porte un à trois **genres** (ce qu'il est) et zéro à six **thèmes** (ce dont il parle), pris dans deux listes fermées, rangées par familles et traduites en anglais. Les genres sont ceux des textes modernes, distincts de ceux du corpus latin (`Work.Genre`) : un article de presse ou un manifeste n'a pas d'équivalent antique ; la science-fiction, le policier et le fantastique sont des thèmes, non des genres. Au moins un genre est exigé à l'ajout d'un texte ; les thèmes restent facultatifs. Les listes ne s'allongent pas par étiquettes libres : elles se modifient dans le code, pour que le filtrage reste sûr et la traduction anglaise complète.
  - Les 52 genres, par famille. *Récits* : roman, nouvelle, conte, mythe et légende, récit de voyage, récit historique, mémoires et autobiographie, biographie, journal intime, littérature de jeunesse. *Idées* : essai, dialogue philosophique, traité, article encyclopédique, texte scientifique, texte technique, texte juridique, texte religieux et sermon, manifeste politique, pamphlet, critique littéraire. *Presse* : article de presse, chronique, reportage, entretien. *Parole* : lettre, discours politique, plaidoirie, oraison funèbre, préface et dédicace, conférence. *Formes brèves* : fable, apologue, maxime et aphorisme, proverbe, anecdote, épigramme, devinette. *Théâtre* : comédie, tragédie, drame, scénario et dialogue de fiction. *Poésie* : poème lyrique, poème épique, poème didactique, chanson, hymne, satire en vers. *Vie courante* : recette et mode d'emploi, annonce et publicité, guide et règlement, correspondance ordinaire.
  - Les 44 thèmes, par famille. *Cité* : guerre et armée, politique et pouvoir, justice et lois, liberté et servitude, foule et société, argent et commerce, travail et métiers. *Esprit* : philosophie et morale, religion et dieux, science et savoir, éducation et enfance, langue et écriture, histoire et mémoire, identité et soi. *Vie* : amour, amitié, famille, mort et deuil, vieillesse et temps qui passe, corps et santé, peur et violence, vie quotidienne. *Monde* : nature et paysages, animaux, mer et navigation, voyage et exil, ville et campagne, ciel et astres, saisons et climat. *Plaisirs* : nourriture et banquet, fête et jeux, sport, art et beauté, musique, humour et satire, rêve et merveilleux. *Aujourd'hui* : techniques et machines, informatique et réseaux, médecine moderne, écologie, économie contemporaine. *Imaginaire* : science-fiction, policier, fantastique.
  - La page « Traduction » se filtre par genre et par thème, et chaque entrée a sa page (`/textes/genre/fable/`, `/textes/theme/animaux/`), adresse qui se partage. Les genres et les thèmes d'un texte paraissent sur sa carte, sur sa page et dans l'API.
...
- Une **vue de comparaison** aligne, phrase par phrase, les traductions de deux projets portant sur le même texte (choix du 21 septembre 2026, qui remplace la comparaison des variantes) ; les variantes de chaque phrase s'affichent à la demande.
...
- **Étapes, à la manière de Git** (choix du 15 septembre 2026) :
  ...
  - ~~Tout compte peut partir de la traduction principale publiée : il obtient une variante, en brouillon, qui mentionne son origine.~~ Retiré le 21 septembre 2026 avec la variante-copie.
  - ~~Tout compte actif peut proposer des modifications à la version publiée d'un autre, acceptées ou refusées phrase par phrase.~~ Remplacé le 21 septembre 2026 par les variantes par phrase.
...
- **Collaborer** : ~~mettre sa copie à jour d'après l'originale, lui proposer ses changements, relectures des propositions, réseau des copies~~ (retiré le 21 septembre 2026 avec la variante-copie) ; restent les étiquettes d'étape (éditions), le retour à une étape et la vue « qui a écrit quoi ».
...
- Recherche par construction (choix du 15 septembre 2026). Une recherche peut chercher une fiche comme construction, par son schéma, là où l'analyse du corpus la repère, et la combiner aux mots par la distance. Les constructions s'affichent en tête des mots, se retirent et s'ajoutent par leur nom, sur la page « Recherche » et dans les recherches d'attestations. La recherche d'attestations d'une fiche part des fiches que marque sa forme de référence (*rēs pūblica* pour `[rēs pūblica;rem pūblicam] administrāre`), puis des autres mots de la forme, par leur lemme (*administro*) ; sur ces pages, les constructions viennent de la forme et ne s'ajoutent pas par leur nom.
- Relations facultatives et mots abstraits (choix du 16 septembre 2026). Une relation du schéma peut être facultative, écrite entre parenthèses : `gero -obj-> bellum; gero -(sp)-> cum; cum -reg-> aliquis` ; le critère est « l'expression existe-t-elle sans elle ? », non la distinction entre actant et circonstant. Une occurrence n'a pas besoin des relations facultatives, qui sont relevées et surlignées quand elles sont là ; la composition des fiches ne regarde que les relations obligatoires. Un nœud du schéma peut être un mot abstrait, classe de mots écrite entre accolades : `sumo -obj-> {liquide}`, `causa -nmod|det-> {possesseur}`. Un mot abstrait est partagé et modéré comme une fiche (proposé par tout compte actif, validé par un relecteur) ; il réunit une à quatre lignes, par « ou », dont chacune combine catégories grammaticales, traits (cas, nombre, genre) et lemmes. La forme de référence porte le mot abstrait (*{liquide} sūmere*) ; son nom ne change plus, son intitulé si. Il ne régit jamais tout le schéma, qui se cherche par son lemme. Le type de la fiche ne dépend pas des mots abstraits. Tout mot du schéma, racine comprise, peut recevoir un cas (`causa:abl -nmod|det-> {possesseur}`), pour que *{possesseur} causā* ne trouve pas *causam Caesaris* (choix du 19 septembre 2026).
