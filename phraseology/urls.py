...
urlpatterns = [
    ...
    path("recherche/schema/mots-abstraits/", views.schema_help_abstracts, name="schema_abstracts"),
    ...
    path("mots-abstraits/", views.abstract_word_list, name="abstract_word_list"),
    path("mots-abstraits/nouveau/", views.abstract_word_create, name="abstract_word_create"),
    path("mots-abstraits/<int:pk>/", views.abstract_word_detail, name="abstract_word"),
    path("mots-abstraits/<int:pk>/modifier/", views.abstract_word_edit, name="abstract_word_edit"),
    path(
        "mots-abstraits/<int:pk>/valider/",
        views.abstract_word_validate,
        name="abstract_word_validate",
    ),
